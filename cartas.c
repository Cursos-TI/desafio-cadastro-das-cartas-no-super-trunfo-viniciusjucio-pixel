...
int main() {
    ...
    //Observação: Eu tinha feito esse código em outro desafio lógica super trunfo, poís eu havia confundido.
    //Então eu copiei e colei aqui nesse desafio cartas super trunfo.
